...
// function to test will be called maxSeq

void testMaxSeq(int * array, size_t n, size_t answer){
  /*
  if (n == 0){
    // if the array is size 0 then maxSeq is definitely 0
    printf("Testing on array of size 0, Implementation thins maxSeq = %d.\n", maxSeq(array, n));
  }
